...
import {
	...
	InputGroupButton,
	InputGroupInput,
} from '@/frontend/shared/ui/input-group'
...
function ComboboxTrigger({ className, children, ...props }: ComboboxPrimitive.Trigger.Props) {
	return (
		...
		>
			{children}
			<Icons className="pointer-events-none size-4 text-muted-foreground" icon="chevron-down" />
		</ComboboxPrimitive.Trigger>
	)
}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
	return (
		<ComboboxPrimitive.Clear
			...
			{...props}
		>
			<Icons className="pointer-events-none" icon="close" />
		</ComboboxPrimitive.Clear>
	)
}

type ComboboxInputProps = Prettify<
...
type ComboboxContentProps = Prettify<
...
function ComboboxItem({ className, children, ...props }: ComboboxPrimitive.Item.Props) {
	return (
		...
		>
			...
			>
				<Icons className="pointer-events-none" icon="check" />
			</ComboboxPrimitive.ItemIndicator>
		</ComboboxPrimitive.Item>
	)
}
...
type ComboboxChipsProps = Prettify<
...
type ComboboxChipProps = Prettify<
