...
function BreadcrumbPage({ className, ...props }: ComponentProps<'span'>) {
	return (
		// biome-ignore lint/a11y/useFocusableInteractive: span with role="link" is not interactive
		// biome-ignore lint/a11y/useSemanticElements: using span for breadcrumb page pattern
		<span
			aria-current="page"
			aria-disabled="true"
...
function BreadcrumbSeparator({ children, className, ...props }: ComponentProps<'li'>) {
	return (
		<li
			...
			{...props}
		>
			{children ?? <Icons icon="chevron-right" />}
		</li>
	)
}
